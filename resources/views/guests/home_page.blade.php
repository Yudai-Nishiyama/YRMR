...
<div class="home">
    ...
    <div class="homeimages mt-3" >
        <div class="images1">
            <a href="#" style="text-decoration: none;"><img src="{{ asset('images/guest_home_1.png') }}"  alt="hotel_bed">
                <div class="homeitem" >
        ...
        <div class="images2">
            <a href="#" style="text-decoration: none;text-align: center;"><img src="{{ asset('images/guest_home_2.png') }}"  alt="hotel_bed" >
                <div class="homeitem" >
        ...
        <div class="images3">
            <a href="#" style="text-decoration: none;text-align: center;"><img src="{{ asset('images/guest_home_sarch.png') }}"  alt="hotel_bed" >
                <div class="homeitem" >
